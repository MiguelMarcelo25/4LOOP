...
import {
  ...
  CardActionArea, // Added CardActionArea
  Dialog, // Added Dialog
...
export default function BusinessesForm() {
  ...
  const [selectedBusiness, setSelectedBusiness] = useState(null); // State for modal
  ...
  return (
    <Paper elevation={2} sx={{ p: 3 }} className="dark:bg-slate-800 dark:text-slate-200">
      <Typography variant="h6" gutterBottom className="dark:text-slate-100">
